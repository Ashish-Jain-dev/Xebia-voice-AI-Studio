...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  // Debug logging for avatar detection
  React.useEffect(() => {
    console.log("=" .repeat(80));
    console.log("🎭 [TileLayout] AVATAR DETECTION DEBUG");
    console.log("=" .repeat(80));
    console.log("📊 useVoiceAssistant Hook:");
    console.log("  - Agent State:", agentState);
    console.log("  - Agent Audio Track:", agentAudioTrack ? "✅ PRESENT" : "❌ MISSING");
    console.log("  - Agent Video Track:", agentVideoTrack ? "✅ PRESENT" : "❌ MISSING");
    console.log("  - Is Avatar Detected:", isAvatar ? "✅ YES" : "❌ NO");
    
    if (agentVideoTrack) {
      console.log("📹 Video Track Details:");
      console.log("  - Dimensions:", videoWidth, "x", videoHeight);
      console.log("  - Source:", agentVideoTrack.source);
      console.log("  - Participant:", agentVideoTrack.participant?.identity);
      console.log("  - Full Track:", agentVideoTrack);
    }
    
    console.log("👥 Remote Participants:", remoteParticipants.length);
    remoteParticipants.forEach((participant, idx) => {
      console.log(`  Participant ${idx + 1}:`, participant.identity);
    ...
    console.log("=" .repeat(80));
  }, [agentState, agentAudioTrack, agentVideoTrack, isAvatar, videoWidth, videoHeight, remoteParticipants]);
        ...
        <div className={cn(classNames.grid)}>
          ...
          >
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                // Audio Agent (No Avatar - Show Visualizer)
                <MotionContainer
                  key="agent"
                  layoutId="agent"
                  initial={{
